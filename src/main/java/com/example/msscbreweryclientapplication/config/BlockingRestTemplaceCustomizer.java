package com.example.msscbreweryclientapplication.config;
...
@Component
public class BlockingRestTemplaceCustomizer implements RestTemplateCustomizer {
    ...
    public BlockingRestTemplaceCustomizer(@Value("${sfg.maxtotalconnections}") Integer maxTotalConnections,
